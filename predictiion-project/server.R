...
shinyServer(function(input, output,session) {
    uni_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/unigrams.Rdata")
    bi_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/bigrams.Rdata")
    tri_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/trigrams.Rdata")
    quad_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/quadgrams.Rdata")
    penta_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/pentagrams.Rdata")
    ecta_df <- readRDS("D:/Projetos/R/Coursera/datascience/final_project/final_project/ectagrams.Rdata")
